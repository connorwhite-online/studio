    ...
    return (
      ...
      >
        ...
        <path 
          ...
          className="radar-wave outer-wave"
          style={{ 
            animation: 'pulseSatellite 1.5s infinite ease-in-out 0.3s',
        ...
        <path 
          ...
          strokeLinecap="round" 
          strokeLinejoin="round"
          className="radar-wave inner-wave"
          style={{ 
            animation: 'pulseSatellite 1.5s infinite ease-in-out',
            transformOrigin: 'center'
          }}
        />
